...
ONLINE_LLM_MODEL = {
    ...
    "zhipu-api": {
        "api_key": "1263d366f1566f82cf9ff83439d2742d.OKYgbpcUSwe01NAm",
    ...
    "qwen-api": {
        "version": "qwen-max-longcontext",  # 可选包括 "qwen-turbo", "qwen-plus" syj updated qwen-max-longcontext qwen-max
        "api_key": "sk-a56072fc20d94bb6823fdc481fbd7108",  # 请在阿里云控制台模型服务灵积API-KEY管理页面创建 syj updated
        "provider": "QwenWorker",
...
MODEL_PATH = {
    "embed_model": {
        ...
        "text2vec": "F:/chatglm/text2vec-large-chinese",
        ...
        "bge-large-zh": "/mnt/workspace/unversal-aikaggle/bge-large-zh",
    ...
    "llm_model": {
        ...
        "chatglm3-6b-32k": "/mnt/workspace/unversal-aikaggle/chatglm3-6b-32k",
