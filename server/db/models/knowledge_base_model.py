...
class KnowledgeBaseModel(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True, comment='文档库ID')
    kb_name = Column(String(50), comment='文档库名称')
    kb_info = Column(String(200), comment='文档库简介(用于Agent)')
