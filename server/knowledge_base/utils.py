...
# change to pinyin for chinese words syj updated
from pypinyin import lazy_pinyin
def get_kb_path(knowledge_base_name: str):
    # return os.path.join(KB_ROOT_PATH, knowledge_base_name)
    return os.path.join(KB_ROOT_PATH, ''.join(lazy_pinyin(knowledge_base_name)))
...
class KnowledgeFile:
    def __init__(
        ...
        '''
        对应文档库目录中的文件，必须是磁盘上存在的才能进行向量化等操作。
        '''
...
if __name__ == "__main__":
    ...
    kb_file = KnowledgeFile(
        filename="/home/congyin/Code/Project_Langchain_0814/北京环球法务小助手/knowledge_base/csv1/content/gm.csv",
